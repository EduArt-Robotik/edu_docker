...
systemd_service_file="eduart-slam.service"
tag="<docker_compose_file_path>"

echo "Deploying Docker Compose Services for lidar SLAM on EduArt robots."
...
# Printing info text.
echo "With following commands you can control the EduArt lidar slam systemd service:"
